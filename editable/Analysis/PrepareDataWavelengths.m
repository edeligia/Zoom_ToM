...
% Date:     August 2019
%
function PrepareDataWavelengths(directory_input, directory_output, varargin)
...
if directory_input(end) ~= filesep
    directory_input(end+1) = filesep;
end
...
if strcmp(directory_input, directory_output)
...
while ~isempty(search)
    ...
    for subpath = search
        ...
        if ~isempty(list)
            ...
            directories(ind).output = strrep(subpath, directory_input, directory_output);
        end
    end
